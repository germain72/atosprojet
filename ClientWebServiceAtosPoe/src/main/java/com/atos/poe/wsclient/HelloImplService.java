 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://imp.webservice.poe.atos.com/", wsdlLocation = "http://localhost:8001/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://imp.webservice.poe.atos.com/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8001/hello?wsdl");
    ...
    public IHello getHelloImplPort() {
        return super.getPort(new QName("http://imp.webservice.poe.atos.com/", "HelloImplPort"), IHello.class);
    }
    ...
    public IHello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://imp.webservice.poe.atos.com/", "HelloImplPort"), IHello.class, features);
    }
